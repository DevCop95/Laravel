...
return [
    ...
    */
    ...
    'collectors' => [
        ...
        'config' => false,                                             // Display config settings (never enable - exposes secrets)
    ...
    'options' => [
        ...
        'db' => [
            'with_params' => env('DEBUGBAR_OPTIONS_WITH_PARAMS', false),  // Render SQL with the parameters substituted (disabled to prevent PII leaks)
        ...
        'session' => [
            'masked' => ['password', 'password_confirmation', 'token', 'secret', 'key', 'app_key'],
        ],
        'symfony_request' => [
        ...
        'config' => [
            'masked' => ['APP_KEY', 'DB_PASSWORD', 'MAIL_PASSWORD', 'REDIS_PASSWORD'],
        ],
        'cache' => [
